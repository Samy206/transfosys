...
/**
 * This is the item provider adapter for a {@link myJava.TypeRef} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypeRefItemProvider extends JTypeItemProvider {
	/**
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TypeRef_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_TypeRef_type_feature", "_UI_TypeRef_type"),
						MyJavaPackage.Literals.TYPE_REF__TYPE, true, false, true, null, null, null));
	}
