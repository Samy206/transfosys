 ...
 *******************************************************************************/
package myjava.generator.common;
...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/myjava/generator/common/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(MyJavaPackage.class)) {
        	// The normal package registration if your metamodel is in a plugin.
        	resourceSet.getPackageRegistry().put(MyJavaPackage.eNS_URI, MyJavaPackage.eINSTANCE);
        	}
    }
