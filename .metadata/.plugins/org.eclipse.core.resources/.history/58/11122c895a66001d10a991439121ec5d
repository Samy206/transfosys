...
/**
 * This is the item provider adapter for a {@link composant.Port} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortItemProvider extends ElementItemProvider {
	/**
	...
	protected void addDirectionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						ComposantPackage.Literals.PORT__DIRECTION, true, false, false,
	...
	protected void addComposantPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Port_composant_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Port_composant_feature", "_UI_Port_type"),
						ComposantPackage.Literals.PORT__COMPOSANT, true, false, true, null, null, null));
	}
